...
```
API Call → AIInferenceInstrumentor → OpenTelemetry Spans
    ↓
Span Processing (add attributes, context)
    ↓
Azure Monitor Exporter → HTTP Transport
    ↓
Application Insights → Azure AI Foundry Dashboard
```

![visualization](assets/flow.svg)